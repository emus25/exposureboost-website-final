...
const PRODUCTS = {
  ...
  keyring:  { name: "NFC Keyring (3-pack) — Shared Profile",    amount: 9900 },
  keyring3: { name: "NFC Keyring (3-pack) — Separate Profiles", amount: 16000 },
...
const TAGIFY_VARIANTS = {
  ...
  // Keyring (3-pack) -> "3 x Mini NFC Keyring Fob". Both profile tiers (shared vs
  // separate) are the same physical item — Tagify only produces the keyrings,
  // profile linking is handled on our side — so they share the same variant IDs.
  "keyring|Regular|": "45288644116774", "keyring|Slanted|": "45288644149542",
  "keyring3|Regular|": "45288644116774", "keyring3|Slanted|": "45288644149542",
